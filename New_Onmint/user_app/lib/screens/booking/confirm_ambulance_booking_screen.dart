...
class ConfirmAmbulanceBookingScreen extends StatefulWidget {
  ...
  @override
  State<ConfirmAmbulanceBookingScreen> createState() => _ConfirmAmbulanceBookingScreenState();
}

class _ConfirmAmbulanceBookingScreenState extends State<ConfirmAmbulanceBookingScreen> {
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                const Text(
                  'Terms & Conditions',
                  style: TextStyle(color: Colors.red, fontSize: 11, decoration: TextDecoration.underline),
                ),
              ],
            ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Row(
                                children: [
                                  Icon(Icons.receipt_long_outlined, color: Colors.red[700], size: 20),
                                ...
                                _buildSummaryRow(Icons.location_on_outlined, 'Pickup Location', widget.pickupLocation),
  ...
  Widget _buildSummaryRow(IconData icon, String label, String value, {bool isLast = false, Color? iconColor, Color? valueColor}) {
    return Column(
      children: [
        Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            Expanded(
              ...
              child: Text(
                ...
                style: TextStyle(color: valueColor ?? Colors.grey[700], fontWeight: FontWeight.w500, fontSize: 11),
              ),
            ),
          ],
        ),
  ...
  Widget _buildPaymentOption({
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          border: Border.all(color: isSelected ? Colors.red : Colors.grey[200]!),
          borderRadius: BorderRadius.circular(10),
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: const Text('VISA', style: TextStyle(color: Colors.white, fontSize: 8, fontWeight: FontWeight.bold)),
                  ),
                  const SizedBox(width: 4),
                  Container(
                    width: 28, height: 16,
                    decoration: BoxDecoration(color: Colors.orange[400], borderRadius: BorderRadius.circular(2)),
                  ),
                ],
              ),
          ],
