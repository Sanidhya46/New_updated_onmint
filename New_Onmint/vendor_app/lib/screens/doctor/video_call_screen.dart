...
class _VideoCallScreenState extends State<VideoCallScreen> {
  ...
  Future<void> _connectToZoom() async {
    try {
      // 1. First, fetch the zoom token
      final tokenResponse = await _apiClient.get('/video/token/${widget.bookingId}');
      
      // Simulate connection time to Zoom SDK
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to connect to Zoom: $e')),
        );
      }
    }
  }
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            // Patient Avatar Circle (Animated if connecting)
            Center(
              child: Stack(
