...
const endVideoCall = async (req, res) => {
  try {
    ...
    // Mark video call as completed but keep booking status as 'in_progress'
    // The booking will be marked as 'completed' only after prescription is created and appointment is completed
